	...
	<div class="container p-3" style="margin-top: 10px">
		<div class="row">
			<div class="col-md-6 text-center pt-2 pl-5 pr-5 pd-5 bg-white">
				<img src="img/<%=p.getPhotoName()%>"
					style="height: 600px; width: 400px;" /><br>
				<div style="margin-top: 10px;">
					<h4>
						Product Name: <span class="text-success"><%=p.getProductName()%></span>
					</h4>
					<h4>
						Gender: <span class="text-success"><%=p.getGender()%></span>
					</h4>
					<h4>
			...
			<div class="col-md-6 text-center p-5 border bg-white">
				...
				<div class="text-center p-3">
					<a href="index.jsp" class="btn btn-success">Continue Shopping</a> <a
						href="" class="btn btn-danger">200</a>
				</div>
				<%
				} else {
				%>
				<div class="text-center p-3">
					...
					%>
					<a style="pointer-events: none; cursor: default; color: white"
